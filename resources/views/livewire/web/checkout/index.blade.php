            ...
            <div class="col-md-6">
                ...
                <div class="card rounded shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <select class="form-select rounded mb-3" wire:model.live="provience_id">
                        ...
                        <select class="form-select rounded mb-3" wire:model.live="city_id"
                            wire:key="{{ $provience_id }}">
                            <option value="">-- Select City --</option>
                            @foreach (\App\Models\City::where('provience_id', $provience_id)->get() as $city)
                ...
                <div class="card rounded shadow-sm border-0 mb-5">
                    <div class="card-body">
                        ...
                        @if ($selectCost > 0)
                            ...
                            <livewire:web.checkout.btn-checkout key="{{ now() }}" :provience_id="$provience_id"
