...
use App\Livewire\Web\Cart\Index as CartIndex;
use App\Livewire\Web\Category\Show as CategoryShow;
use App\Livewire\Web\Checkout\Index as CheckoutIndex;
use App\Livewire\Web\Counter;
...
Route::get('/cart', CartIndex::class)->name('web.cart.index')->middleware('auth:customer');
Route::get('/checkout', CheckoutIndex::class)->name('web.checkout.index')->middleware('auth:customer');
Route::get('/test', Counter::class)->name('counter');